...
```js
import { UidCast } from 'pinia-orm/packages/nanoid'
// import { UidCast } from 'pinia-orm/packages/nanoid/non-secure'
// import { UidCast } from 'pinia-orm/packages/nanoid/async'
...
```ts
import { Uid } from 'pinia-orm/packages/nanoid'
// import { Uid } from 'pinia-orm/packages/nanoid/non-secure'
// import { Uid } from 'pinia-orm/packages/nanoid/async'
...
```js
import { UidCast } from 'pinia-orm/packages/uuid/v1'
// import { UidCast } from 'pinia-orm/packages/uuid/v4'
